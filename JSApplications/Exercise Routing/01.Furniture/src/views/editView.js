    ...
    <div class="row space-top">
        ...
        <div class="col-md-4">
            ...
            <div class="form-group">
                ...
                <input class="form-control ${!!error ? error.image ? 'is-invalid' : 'is-valid' : ''}" id="new-image" type="text" name="img" value="${item.img}">
            </div>
            <div class="form-group">
...
export async function showEditView(ctx) {
    ...
    const item = await dataService.furnitureDetails(id);
