...
function createMoviePreview(movie) {
    ...
    element.innerHTML = `<a href="${movie._id}">${movie.title}</a>`;

    element.querySelector("a").addEventListener("click", event => showView("detailsView", showDetailsView, event, movie._id));
    return element;
}